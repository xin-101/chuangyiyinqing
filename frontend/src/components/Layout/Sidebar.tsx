...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-56 z-30 glass-card rounded-none border-r border-slate-200 flex flex-col">
      {/* Logo */}
      <div className="p-5 border-b border-slate-100">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-400">多模态AI创意智能体</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-slate-100">
        <p className="text-[10px] text-slate-400 text-center">v1.0 · AI 创意引擎</p>
      </div>
    </aside>
  );
}
